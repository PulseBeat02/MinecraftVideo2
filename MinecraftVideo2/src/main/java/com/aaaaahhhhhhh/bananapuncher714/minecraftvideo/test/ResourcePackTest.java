...
import com.aaaaahhhhhhh.bananapuncher714.minecraftvideo.internet.VideoResource;
...
public class ResourcePackTest {
	...
	public static void main(String[] args) throws IOException {
		...
		createEmptyZipFile(new VideoResource(vid, sound));

	}
	
	public static void createEmptyZipFile(VideoResource v) throws IOException {
	...
	public static void createServerZipFile(VideoResource v, File file) throws IOException {
