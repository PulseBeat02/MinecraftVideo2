package io.github.bananapuncher714.minecraftvideo.implementation.v1_15_R1;
...
import net.minecraft.server.v1_15_R1.PacketPlayInResourcePackStatus.EnumResourcePackStatus;
...
public class NMSHandler implements PacketHandler {
	...
	public void playSound( UUID uuid, String id, Location location, double volume ) {
		PacketPlayOutCustomSoundEffect packet = new PacketPlayOutCustomSoundEffect( new MinecraftKey( id ), SoundCategory.MASTER, new Vec3D( location.getX(), location.getY(), location.getZ() ), ( float ) volume, 1f );
	...
	public void stopSound( UUID uuid, String id ) {
		PacketPlayOutStopSound packet = new PacketPlayOutStopSound( new MinecraftKey( id ), SoundCategory.MASTER );
