...
//  Sadly unused because of some overhead costs
...
//		for (int i = 4; i < palette.length; ++i) {
//			col = palette[i];
//			distance = getDistance(red, green, blue, col >> 16 & 0xFF, col >> 8 & 0xFF, col & 0xFF);
//			if (distance < best_distance) {
//				best_distance = distance;
//				val = i;
//			}
...
//		int redVal = red - red2;
//		int greenVal = green - green2;
//		int blueVal = blue - blue2;
//		float weight_red = 2.0f + red_avg * ( 1f / 256f );
//		float weight_green = 4.0f;
//		float weight_blue = 2.0f + ( 255.0f - red_avg ) * ( 1f / 256f );
...
//	}
	...
	public static byte[] convert( Image input, int width, int height ) {
		...
		return dither( image.getWidth(), imageArr );
	}
}